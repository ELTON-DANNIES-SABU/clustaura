...
class HybridRanker:
    ...
    def rank(self, candidates: List[str], problem_data: Any, user_db: Dict[str, Any], semantic_score_map: Dict[str, float]) -> List[Dict]:
        """
        ...
        for uid in candidates:
            ...
            # 1. Ontology Score (Passed the gate -> 1.0)
            # In a refined version, partial matches could have lower scores.
            score_onto = 1.0
    ...
    def _generate_explanation(self, user, sem_score, exp_score):
        reasons = []
        if sem_score > 0.7:
        ...
        if exp_score > 0.5:
            ...
            reasons.append("Meets technical capability requirements.")

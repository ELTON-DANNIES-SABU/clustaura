    ...
    const FooterNavbar = () => (
        <nav className="footer-navbar">
            <div className="navbar-content">
                ...
                <button
                    className={`navbar-btn ${activeNav === 'settings' ? 'active' : ''}`}
                    onClick={() => setActiveNav('settings')}
                    title="Settings"
                >
                    <span className="navbar-icon">
                        <SettingsIcon isActive={activeNav === 'settings'} />
                    </span>
                ...
                <div className="dashboard-container">
                    ...
                    <div className="posting-section">
                        ...
                        <div className="layout-buttons-container">
                            <button
                                className={`layout-btn ${activeLayoutBtn === 'challenges' ? 'active' : ''}`}
                                onClick={() => handleLayoutButtonClick('challenges')}
                            >
                                <span className="layout-btn-icon">💡</span>
                                <span className="layout-btn-text">Posts</span>
                            </button>

                            <button
                                className={`layout-btn ${activeLayoutBtn === 'community' ? 'active' : ''}`}
                                onClick={() => handleLayoutButtonClick('community')}
                            >
                                <span className="layout-btn-icon">👥</span>
                                <span className="layout-btn-text">Community Challenges</span>
                            </button>

                            <button
                                className={`layout-btn ${activeLayoutBtn === 'communication' ? 'active' : ''}`}
                                onClick={() => handleLayoutButtonClick('communication')}
                            >
                                <span className="layout-btn-icon">💬</span>
                                <span className="layout-btn-text">Clustaura Communication</span>
                            </button>

                            <button
                                className={`layout-btn ${activeLayoutBtn === 'workplace' ? 'active' : ''}`}
                                onClick={() => handleLayoutButtonClick('workplace')}
                            >
                                <span className="layout-btn-icon">🏢</span>
                                <span className="layout-btn-text">Clustaura Workplace</span>
                            </button>
                        </div>

                        <div className="posting-card">
                            <h2 className="posting-title">Create a Post</h2>
                            <p className="posting-subtitle">Share your work, experience, progress, or thoughts with the community</p>

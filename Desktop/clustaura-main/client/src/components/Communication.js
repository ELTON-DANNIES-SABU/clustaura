...
const Communication = () => {
    ...
    const startCall = (video = true) => {
        ...
        // For DMs: pass target userId as participants so server knows who to ring
        const participants = activeType === 'dm' ? [activeId] : undefined;
        startCallGlobal(activeId, video ? 'video' : 'audio', participants);
    };
